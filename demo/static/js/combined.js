...
(function() {
  var App, CrdFile, CrdFileParser, CrdFileReader, CrdFileStorage, Line, Section, Song, SongWriter,
  ...
  App = (function() {
    ...
    function App(__song_storage, __crd_file_reader, __crd_file_parser, __song_writer, __touch_support) {
      ...
      this.showSongsheet = __bind(this.showSongsheet, this);
    ...
    App.prototype.initialise = function() {
      ...
      if (!this.__touch_support) {
        this.__el_panel.on("mouseenter", this.showPanel);
        return this.__el_songsheet.on("mouseenter", this.showSongsheet);
      }
    };

    App.prototype.showPanel = function() {
      if (!this.__el_app.hasClass("showing-panel")) {
        return this.__el_app.addClass("showing-panel");
      }
    };

    App.prototype.showSongsheet = function() {
  ...
  SongWriter = (function() {
    var app, crd_file_reader, doc, input, label;
    ...
    if (Modernizr.touch) {
      doc = Hammer(document);
      doc.on("swiperight", SongWriter.showPanel);
      doc.on("swipeleft", SongWriter.showSongsheet);
    }
